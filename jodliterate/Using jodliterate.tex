...
\begin{document}
    ...
    %\includegraphics{https://bakerjd99.files.wordpress.com/2020/11/jodliteratelionlittle-1.png}
...
%\includegraphics{https://bakerjd99.files.wordpress.com/2020/05/literate_programming_book_cover_smaller.png}
...
\PY{c+c1}{NB. Verb to convert character tables to newline delimited }
\PY{c+c1}{NB. lists. Useful for displaying J tables in Jupyter}
\PY{n+nv}{ctl\PYZus{}ijod\PYZus{}}\PY{o}{=:}\PY{o}{\PYZcb{}}\PY{o}{.}\PY{o}{@}\PY{p}{(}\PY{o}{,}\PY{o}{@}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{\PYZam{}}\PY{p}{(}\PY{o}{,}\PY{o}{\PYZdq{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{@}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{o}{.}\PY{o}{@}\PY{p}{(}\PY{o}{*}\PY{o}{.}\PY{o}{/}\PY{o}{\PYZbs{}}\PY{o}{.}\PY{o}{\PYZdq{}}\PY{l+m+mi}{1}\PY{o}{@}\PY{p}{(}\PY{o}{=}\PY{o}{\PYZam{}}\PY{l+s}{\PYZsq{}}\PY{l+s}{ }\PY{l+s}{\PYZsq{}}\PY{o}{@}\PY{o}{]}\PY{p}{)}\PY{p}{)}\PY{p}{)}\PY{p}{)} \PY{o}{\PYZsh{}} \PY{o}{,}\PY{o}{@}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{10}\PY{o}{\PYZob{}}\PY{n+nv}{a}\PY{o}{.}\PY{p}{)}\PY{o}{\PYZam{}}\PY{p}{(}\PY{o}{,}\PY{o}{\PYZdq{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{@}\PY{o}{]}\PY{p}{)}\PY{p}{)}

\PY{c+c1}{NB. Appends line feed character if necessary.}
\PY{n+nv}{tlf\PYZus{}ijod\PYZus{}}\PY{o}{=:}\PY{o}{]} \PY{o}{,} \PY{p}{(}\PY{p}{(}\PY{l+m+mi}{10}\PY{o}{\PYZob{}}\PY{n+nv}{a}\PY{o}{.}\PY{p}{)}\PY{o}{\PYZdq{}}\PY{l+m}{\PYZus{}} \PY{o}{=} \PY{o}{\PYZob{}}\PY{o}{:}\PY{p}{)} \PY{o}{\PYZcb{}}\PY{o}{.} \PY{p}{(}\PY{l+m+mi}{10}\PY{o}{\PYZob{}}\PY{n+nv}{a}\PY{o}{.}\PY{p}{)}\PY{o}{\PYZdq{}}\PY{l+m}{\PYZus{}}
...
%\includegraphics{https://bakerjd99.files.wordpress.com/2020/05/jqt_pacman_menu-1.png}
\includegraphics{inclusions/jqt_pacman_menu.png}

pacman shows all available addons and provides tools for installing,
updating, and removing them.

%\includegraphics{https://bakerjd99.files.wordpress.com/2020/05/jqt_pacman.png}
...
\PY{c+c1}{NB. some common paths to pandoc }
\PY{c+c1}{NB. PREFERREDPANDOC\PYZus{}ijod\PYZus{}=: \PYZsq{}\PYZdq{}C:\PYZbs{}Program Files\PYZbs{}Pandoc\PYZbs{}pandoc\PYZdq{}\PYZsq{}}
\PY{n+nv}{PREFERREDPANDOC\PYZus{}ijod\PYZus{}}\PY{o}{=:} \PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZdq{}}\PY{l+s}{C}\PY{l+s}{:}\PY{l+s}{\PYZbs{}}\PY{l+s}{U}\PY{l+s}{s}\PY{l+s}{e}\PY{l+s}{r}\PY{l+s}{s}\PY{l+s}{\PYZbs{}}\PY{l+s}{j}\PY{l+s}{o}\PY{l+s}{h}\PY{l+s}{n}\PY{l+s}{.}\PY{l+s}{b}\PY{l+s}{a}\PY{l+s}{k}\PY{l+s}{e}\PY{l+s}{r}\PY{l+s}{\PYZbs{}}\PY{l+s}{A}\PY{l+s}{p}\PY{l+s}{p}\PY{l+s}{D}\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{a}\PY{l+s}{\PYZbs{}}\PY{l+s}{L}\PY{l+s}{o}\PY{l+s}{c}\PY{l+s}{a}\PY{l+s}{l}\PY{l+s}{\PYZbs{}}\PY{l+s}{P}\PY{l+s}{a}\PY{l+s}{n}\PY{l+s}{d}\PY{l+s}{o}\PY{l+s}{c}\PY{l+s}{\PYZbs{}}\PY{l+s}{p}\PY{l+s}{a}\PY{l+s}{n}\PY{l+s}{d}\PY{l+s}{o}\PY{l+s}{c}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZsq{}}

\PY{c+c1}{NB. use when correct version is on the shell path}
\PY{c+c1}{NB. PREFERREDPANDOC\PYZus{}ijod\PYZus{} \PYZsq{}pandoc\PYZsq{} }

\PY{c+c1}{NB. the pandoc jodliterate uses}
\PY{n+nv}{THISPANDOC\PYZus{}ajodliterate\PYZus{}}\PY{o}{=:} \PY{n+nv}{PREFERREDPANDOC\PYZus{}ijod\PYZus{}}

\PY{n+nv}{chkpandoc}\PY{o}{=:} \PY{n+nf}{3 : 0}
\PY{n+nl}{if.} \PY{o}{+}\PY{o}{.}\PY{o}{/}\PY{o}{@}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{p}\PY{l+s}{a}\PY{l+s}{n}\PY{l+s}{d}\PY{l+s}{o}\PY{l+s}{c}\PY{l+s}{\PYZsq{}}\PY{o}{\PYZam{}}\PY{n+nv}{E}\PY{o}{.}\PY{p}{)} \PY{n+nv}{panver}\PY{o}{=.} \PY{o}{;}\PY{l+m+mi}{0}\PY{o}{\PYZob{}} \PY{o}{\PYZlt{}}\PY{o}{;}\PY{o}{.}\PY{l+m+mi}{\PYZus{}2} \PY{n+nv}{tlf} \PY{p}{(}\PY{n+nv}{shell} \PY{n+nv}{THISPANDOC\PYZus{}ajodliterate\PYZus{}}\PY{o}{,}\PY{l+s}{\PYZsq{}}\PY{l+s}{ }\PY{l+s}{\PYZhy{}}\PY{l+s}{\PYZhy{}}\PY{l+s}{v}\PY{l+s}{e}\PY{l+s}{r}\PY{l+s}{s}\PY{l+s}{i}\PY{l+s}{o}\PY{l+s}{n}\PY{l+s}{\PYZsq{}}\PY{p}{)} \PY{o}{\PYZhy{}}\PY{o}{.} \PY{n+nv}{CR} \PY{n+nl}{do.}
  \PY{l+s}{\PYZsq{}}\PY{l+s}{N}\PY{l+s}{O}\PY{l+s}{T}\PY{l+s}{E}\PY{l+s}{:}\PY{l+s}{ }\PY{l+s}{a}\PY{l+s}{d}\PY{l+s}{j}\PY{l+s}{u}\PY{l+s}{s}\PY{l+s}{t}\PY{l+s}{ }\PY{l+s}{p}\PY{l+s}{a}\PY{l+s}{n}\PY{l+s}{d}\PY{l+s}{o}\PY{l+s}{c}\PY{l+s}{ }\PY{l+s}{p}\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{h}\PY{l+s}{ }\PY{l+s}{i}\PY{l+s}{f}\PY{l+s}{ }\PY{l+s}{v}\PY{l+s}{e}\PY{l+s}{r}\PY{l+s}{s}\PY{l+s}{i}\PY{l+s}{o}\PY{l+s}{n}\PY{l+s}{ }\PY{l+s}{(}\PY{l+s}{\PYZsq{}}\PY{o}{,}\PY{n+nv}{panver}\PY{o}{,}\PY{l+s}{\PYZsq{}}\PY{l+s}{)}\PY{l+s}{ }\PY{l+s}{i}\PY{l+s}{s}\PY{l+s}{ }\PY{l+s}{n}\PY{l+s}{o}\PY{l+s}{t}\PY{l+s}{ }\PY{l+s}{\PYZgt{}}\PY{l+s}{=}\PY{l+s}{ }\PY{l+s}{2}\PY{l+s}{.}\PY{l+s}{9}\PY{l+s}{.}\PY{l+s}{1}\PY{l+s}{.}\PY{l+s}{1}\PY{l+s}{\PYZsq{}}
\PY{n+nl}{else.}
  \PY{l+s}{\PYZsq{}}\PY{l+s}{E}\PY{l+s}{R}\PY{l+s}{R}\PY{l+s}{O}\PY{l+s}{R}\PY{l+s}{:}\PY{l+s}{ }\PY{l+s}{p}\PY{l+s}{a}\PY{l+s}{n}\PY{l+s}{d}\PY{l+s}{o}\PY{l+s}{c}\PY{l+s}{ }\PY{l+s}{n}\PY{l+s}{o}\PY{l+s}{t}\PY{l+s}{ }\PY{l+s}{s}\PY{l+s}{e}\PY{l+s}{t}\PY{l+s}{ }\PY{l+s}{\PYZhy{}}\PY{l+s}{ }\PY{l+s}{a}\PY{l+s}{d}\PY{l+s}{j}\PY{l+s}{u}\PY{l+s}{s}\PY{l+s}{t}\PY{l+s}{ }\PY{l+s}{T}\PY{l+s}{H}\PY{l+s}{I}\PY{l+s}{S}\PY{l+s}{P}\PY{l+s}{A}\PY{l+s}{N}\PY{l+s}{D}\PY{l+s}{O}\PY{l+s}{C}\PY{l+s}{\PYZus{}}\PY{l+s}{a}\PY{l+s}{j}\PY{l+s}{o}\PY{l+s}{d}\PY{l+s}{l}\PY{l+s}{i}\PY{l+s}{t}\PY{l+s}{e}\PY{l+s}{r}\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{e}\PY{l+s}{\PYZus{}}\PY{l+s}{\PYZsq{}}
  \PY{l+s}{\PYZsq{}}\PY{l+s}{T}\PY{l+s}{H}\PY{l+s}{I}\PY{l+s}{S}\PY{l+s}{P}\PY{l+s}{A}\PY{l+s}{N}\PY{l+s}{D}\PY{l+s}{O}\PY{l+s}{C}\PY{l+s}{\PYZus{}}\PY{l+s}{a}\PY{l+s}{j}\PY{l+s}{o}\PY{l+s}{d}\PY{l+s}{l}\PY{l+s}{i}\PY{l+s}{t}\PY{l+s}{e}\PY{l+s}{r}\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{e}\PY{l+s}{\PYZus{}}\PY{l+s}{=}\PY{l+s}{:}\PY{l+s}{ }\PY{l+s}{\PYZsq{}\PYZsq{}}\PY{l+s}{p}\PY{l+s}{a}\PY{l+s}{n}\PY{l+s}{d}\PY{l+s}{o}\PY{l+s}{c}\PY{l+s}{\PYZsq{}\PYZsq{}}\PY{l+s}{ }\PY{l+s}{N}\PY{l+s}{B}\PY{l+s}{.}\PY{l+s}{ }\PY{l+s}{w}\PY{l+s}{h}\PY{l+s}{e}\PY{l+s}{n}\PY{l+s}{ }\PY{l+s}{p}\PY{l+s}{a}\PY{l+s}{n}\PY{l+s}{d}\PY{l+s}{o}\PY{l+s}{c}\PY{l+s}{ }\PY{l+s}{o}\PY{l+s}{n}\PY{l+s}{ }\PY{l+s}{p}\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{h}\PY{l+s}{\PYZsq{}}
\PY{n+nl}{end.}
\PY{n+nl}{)}

\PY{n+nv}{smoutput} \PY{n+nv}{shell} \PY{n+nv}{THISPANDOC\PYZus{}ajodliterate\PYZus{}}\PY{o}{,}\PY{l+s}{\PYZsq{}}\PY{l+s}{ }\PY{l+s}{\PYZhy{}}\PY{l+s}{\PYZhy{}}\PY{l+s}{v}\PY{l+s}{e}\PY{l+s}{r}\PY{l+s}{s}\PY{l+s}{i}\PY{l+s}{o}\PY{l+s}{n}\PY{l+s}{\PYZsq{}}
\PY{n+nv}{chkpandoc} \PY{l+m+mi}{0}
\end{Verbatim}
\end{tcolorbox}
...
Default user data directory: C:\textbackslash{}Users\textbackslash{}john.baker\textbackslash{}AppData\textbackslash{}Roaming\textbackslash{}pandoc
...
\PY{c+c1}{NB. check that J is on the supported languages list}
...
\PY{n+nv}{ctl} \PY{l+m+mi}{80} \PY{n+nv}{list} \PY{n+nv}{shell} \PY{n+nv}{pcmd}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
+-+--------------------+--------------------------------------------------- {\ldots}
|1|load script saved ->|c:/users/john.baker/onedrive - jackson companies/jo {\ldots}
+-+--------------------+--------------------------------------------------- {\ldots}
    \end{Verbatim}
...
\PY{c+c1}{NB. set the output directory \PYZhy{} when running in Jupyter }
\PY{c+c1}{NB. use a subdirectory of your notebook directory other }
\PY{c+c1}{NB. directories generate access errors \PYZhy{} you really don\PYZsq{}t}
\PY{c+c1}{NB. want web browsers roaming your drives unsupervised}

\PY{c+c1}{NB. ltxpath=: \PYZsq{}C:\PYZbs{}Users\PYZbs{}john\PYZbs{}AnacondaProjects\PYZbs{}testfolder\PYZbs{}grplit\PYZbs{}\PYZsq{} }
\PY{n+nv}{ltxpath}\PY{o}{=:} \PY{l+s}{\PYZsq{}}\PY{l+s}{C}\PY{l+s}{:}\PY{l+s}{\PYZbs{}}\PY{l+s}{U}\PY{l+s}{s}\PY{l+s}{e}\PY{l+s}{r}\PY{l+s}{s}\PY{l+s}{\PYZbs{}}\PY{l+s}{j}\PY{l+s}{o}\PY{l+s}{h}\PY{l+s}{n}\PY{l+s}{.}\PY{l+s}{b}\PY{l+s}{a}\PY{l+s}{k}\PY{l+s}{e}\PY{l+s}{r}\PY{l+s}{\PYZbs{}}\PY{l+s}{b}\PY{l+s}{i}\PY{l+s}{x}\PY{l+s}{m}\PY{l+s}{l}\PY{l+s}{\PYZbs{}}\PY{l+s}{b}\PY{l+s}{l}\PY{l+s}{o}\PY{l+s}{g}\PY{l+s}{\PYZbs{}}\PY{l+s}{g}\PY{l+s}{r}\PY{l+s}{p}\PY{l+s}{l}\PY{l+s}{i}\PY{l+s}{t}\PY{l+s}{\PYZbs{}}\PY{l+s}{\PYZsq{}}

\PY{c+c1}{NB. (x) argument sets LaTeX \PYZbs{}author\PYZob{}\PYZcb{} text}
\PY{l+s}{\PYZsq{}}\PY{l+s}{B}\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{m}\PY{l+s}{a}\PY{l+s}{n}\PY{l+s}{ }\PY{l+s}{(}\PY{l+s}{\PYZbs{}}\PY{l+s}{t}\PY{l+s}{e}\PY{l+s}{x}\PY{l+s}{t}\PY{l+s}{t}\PY{l+s}{t}\PY{l+s}{\PYZob{}}\PY{l+s}{d}\PY{l+s}{n}\PY{l+s}{@}\PY{l+s}{j}\PY{l+s}{l}\PY{l+s}{.}\PY{l+s}{c}\PY{l+s}{o}\PY{l+s}{m}\PY{l+s}{\PYZcb{}}\PY{l+s}{)}\PY{l+s}{\PYZsq{}} \PY{n+nv}{setjodliterate} \PY{n+nv}{ltxpath}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
+-+--------------------------------------+
|1|C:\textbackslash{}Users\textbackslash{}john.baker\textbackslash{}bixml\textbackslash{}blog\textbackslash{}grplit\textbackslash{}|
+-+--------------------------------------+
    \end{Verbatim}
...
|1                                                     |
+------------------------------------------------------+
|C:\textbackslash{}Users\textbackslash{}john.baker\textbackslash{}bixml\textbackslash{}blog\textbackslash{}grplit\textbackslash{}sunmoon.tex     |
+------------------------------------------------------+
|C:\textbackslash{}Users\textbackslash{}john.baker\textbackslash{}bixml\textbackslash{}blog\textbackslash{}grplit\textbackslash{}sunmoontitle.tex|
+------------------------------------------------------+
|C:\textbackslash{}Users\textbackslash{}john.baker\textbackslash{}bixml\textbackslash{}blog\textbackslash{}grplit\textbackslash{}sunmoonoview.tex|
+------------------------------------------------------+
|C:\textbackslash{}Users\textbackslash{}john.baker\textbackslash{}bixml\textbackslash{}blog\textbackslash{}grplit\textbackslash{}sunmooncode.tex |
+------------------------------------------------------+
|C:\textbackslash{}Users\textbackslash{}john.baker\textbackslash{}bixml\textbackslash{}blog\textbackslash{}grplit\textbackslash{}sunmoon.bat     |
+------------------------------------------------------+
    \end{Verbatim}
...
C:\textbackslash{}Users\textbackslash{}john.baker\textbackslash{}bixml\textbackslash{}blog\textbackslash{}grplit>endlocal

    \end{Verbatim}

    Instead of compiling \(\LaTeX\) with shell commands issued from a J
kernel running under Jupyter it's easier to navigate to the output
directory and manually run the generated scripts. This is particularily
the case if you have to edit the files. From the good old fashioned DOS
prompt do something like:
...
However, before you can \emph{try} \texttt{jodliterate} you have to
\texttt{put} document fragments in JOD dictionaries.
...
\item
  ...
  \texttt{2\ 9\ put\ \textquotesingle{}groupname\textquotesingle{}}
\item
  \(\LaTeX\) overview macros:
  \texttt{4\ put\ \textquotesingle{}groupname\textquotesingle{},\textquotesingle{}\_oview\_tex\textquotesingle{}}
\end{enumerate}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
+-+---------------------+------------------------------------------+------- {\ldots}
|1|dictionary created ->|aaa138032830560151674235281395581473261722|c:/user {\ldots}
+-+---------------------+------------------------------------------+------- {\ldots}
    \end{Verbatim}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
+-+-------------------------------+------------------------------------------+
|1|5 word explanation(s) put in ->|aaa138032830560151674235281395581473261722|
+-+-------------------------------+------------------------------------------+
    \end{Verbatim}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
+-+--------------------------+------------------------------------------+
|1|group <litmacro> put in ->|aaa138032830560151674235281395581473261722|
+-+--------------------------+------------------------------------------+
    \end{Verbatim}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
+-+-------------------+------------------------------------------+
|1|1 word(s) put in ->|aaa138032830560151674235281395581473261722|
+-+-------------------+------------------------------------------+
    \end{Verbatim}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
+-+-----------------------------+------------------------------------------+
|1|1 group document(s) put in ->|aaa138032830560151674235281395581473261722|
+-+-----------------------------+------------------------------------------+
    \end{Verbatim}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
+---------------------------------------------------+
|C:\textbackslash{}Users\textbackslash{}john.baker\textbackslash{}bixml\textbackslash{}blog\textbackslash{}grplit\textbackslash{}litheader.bat|
+---------------------------------------------------+
    \end{Verbatim}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
+--------------------------------------------------+
|C:\textbackslash{}Users\textbackslash{}john.baker\textbackslash{}bixml\textbackslash{}blog\textbackslash{}grplit\textbackslash{}litmacro.bat|
+--------------------------------------------------+
    \end{Verbatim}
